...
public class WhatToDo extends SherlockActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		wvWhatToDo = (WebView) findViewById(R.id.wv_what_to_do);
		wvWhatToDo.getSettings().setSupportZoom(true);
		wvWhatToDo.getSettings().setBuiltInZoomControls(true);
		...
		try {
			...
			wvWhatToDo.loadDataWithBaseURL("file:///android_asset/", htmlData,
	...
	public String getText() throws Exception {
		InputStream is = getAssets().open("WhatToDo.txt");
