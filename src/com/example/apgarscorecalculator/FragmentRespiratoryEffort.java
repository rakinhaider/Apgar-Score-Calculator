...
public class FragmentRespiratoryEffort extends Fragment {
	
	WebView wvDetailsResEffort;
	
	@Override
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
			Bundle savedInstanceState) {
		// TODO Auto-generated method stub
		View view=inflater.inflate(R.layout.frag_resp_effort, null, false);
		...
		SpannableString customText = AndroidCustomFontSupport
				.getCorrectedBengaliFormat(getString(R.string.app_name_bangla),
						font, (float)1.2);
		wvDetailsResEffort= (WebView)view.findViewById(R.id.details_resp_effort);
		wvDetailsResEffort.getSettings().setSupportZoom(true);
		wvDetailsResEffort.getSettings().setBuiltInZoomControls(true);
		...
		try {
			...
			wvDetailsResEffort.loadDataWithBaseURL("file:///android_asset/", htmlData,
	...
	public String getText() throws Exception {
		InputStream is = getActivity().getAssets().open("DetailsRespEffort.txt");
