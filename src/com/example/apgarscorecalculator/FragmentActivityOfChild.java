...
public class FragmentActivityOfChild extends Fragment {

	WebView wvDetailsActivity;
	
	@Override
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
			Bundle savedInstanceState) {
		// TODO Auto-generated method stub
		View view=inflater.inflate(R.layout.frag_activity, null, false);
		...
		SpannableString customText = AndroidCustomFontSupport
				.getCorrectedBengaliFormat(getString(R.string.app_name_bangla),
						font, (float)1.2);
		wvDetailsActivity= (WebView)view.findViewById(R.id.details_activity);
		wvDetailsActivity.getSettings().setSupportZoom(true);
		wvDetailsActivity.getSettings().setBuiltInZoomControls(true);
		...
		try {
			...
			wvDetailsActivity.loadDataWithBaseURL("file:///android_asset/", htmlData,
	...
	public String getText() throws Exception {
		InputStream is = getActivity().getAssets().open("DetailsActivityOfChild.txt");
