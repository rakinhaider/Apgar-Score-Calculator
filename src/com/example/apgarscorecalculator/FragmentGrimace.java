...
public class FragmentGrimace extends Fragment {

	WebView wvDetailsGrimace;
	
	@Override
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
			Bundle savedInstanceState) {
		// TODO Auto-generated method stub
		View view=inflater.inflate(R.layout.frag_grimace, null, false);
		...
		SpannableString customText = AndroidCustomFontSupport
				.getCorrectedBengaliFormat(getString(R.string.app_name_bangla),
						font, (float)1.2);
		wvDetailsGrimace= (WebView)view.findViewById(R.id.details_grimace);
		wvDetailsGrimace.getSettings().setSupportZoom(true);
		wvDetailsGrimace.getSettings().setBuiltInZoomControls(true);
		...
		try {
			...
			wvDetailsGrimace.loadDataWithBaseURL("file:///android_asset/", htmlData,
	...
	public String getText() throws Exception {
		InputStream is = getActivity().getAssets().open("DetailsGrimace.txt");
